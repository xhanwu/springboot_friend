$(function () {
    $("#jqGrid").jqGrid({
        ...
        datatype: "json",
        colModel: [
            {label: 'uid', name: 'uId', index: 'uId', width: 50, key: true, hidden: false},
            {label: '昵称', name: 'nickname', index: 'nickname', width: 140},
...
function search() {
    ...
    //提交post并刷新表格
    $("#jqGrid").jqGrid("setGridParam", {url: '/admin/members/list'}).trigger("reloadGrid");
}
...
/*function addBlog() {
    window.location.href = "/admin/members/edit";
}*/
...
function editBlog() {
    ...
    window.location.href = "/admin/members/edit/" + id;
}
